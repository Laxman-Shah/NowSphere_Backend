...
namespace smartApi.Migrations
{
    ...
    [Migration("20260719085657_RemoveUserSessionIdColumnFromRefreshTokens")]
    partial class RemoveUserSessionIdColumnFromRefreshTokens
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("smartApi.Entity.RefreshToken", b =>
                {
                    ...
                    b.HasOne("smartApi.Entity.UserSession", null)
                        .WithMany("RefreshTokens")
                        .HasForeignKey("UserSessionId");
