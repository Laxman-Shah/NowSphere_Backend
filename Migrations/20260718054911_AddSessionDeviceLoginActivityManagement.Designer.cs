...
namespace smartApi.Migrations
{
    ...
    [Migration("20260718054911_AddSessionDeviceLoginActivityManagement")]
    partial class AddSessionDeviceLoginActivityManagement
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("smartApi.Entity.RefreshToken", b =>
                {
                    ...
                    b.HasIndex("UserSessionId", "ExpiresAt")
                        .HasDatabaseName("idx_refresh_tokens_session_expiry");

                    b.HasIndex("UserSessionId", "IsRevoked")
                        .HasDatabaseName("idx_refresh_tokens_session_revoked");

                    b.HasIndex("UserSessionId", "TokenFamilyId")
                        .HasDatabaseName("idx_refresh_tokens_session_family");
